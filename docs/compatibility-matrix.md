...
| Bazaar item identity | Registry item, plain-item policy, or configured exact NBT identity | Exact products deserialize and compare the complete canonical stack. Product versions are immutable after escrow use. |
