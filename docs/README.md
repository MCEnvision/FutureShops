...
* [External economy provider compatibility](compatibility/external-economy-providers.md)

## Configuration

* [FutureShops 3.1 trade offers](config-3.1-offers.md)
* [FutureShops 3.0 configuration examples](config-3.0-examples.md)
* [Bazaar products](bazaar-products.md)
* [Compatibility matrix](compatibility-matrix.md)

## Design and release

* [Forge 1.20.1 beta.3 backport and hardening plan](general/plan.md)
* [Nocturne interface specification](redesign-nocturne-spec.md)
* [FutureShops 3.0.0 beta release notes](release-notes-3.0-beta.md)
* [3.0.0 beta 5 dependency alert disposition](security/dependency-alerts-3.0-beta.5.md)
* [3.0.0 beta 3 dependency alert disposition](security/dependency-alerts-3.0-beta.3.md)
* [3.0.0 beta 4 dependency alert disposition](security/dependency-alerts-3.0-beta.4.md)
...
* [Phase 008 shop snapshot protocol entry](verification/phase-008/shop-snapshot-protocol-2026-09-24.md)
* [Phase 008 donor ledger closure](verification/phase-008/donor-ledger-closure-2026-09-24.md)
...
* [Phase 004 completion evidence](verification/phase-004/completion-2026-09-24.md)

The root [README](../README.md) is the installation and contributor entry point. [Technical documentation](../DOCUMENTATION.md) is the maintainer architecture and operations reference. Verification records above are historical evidence, not an active implementation plan.
