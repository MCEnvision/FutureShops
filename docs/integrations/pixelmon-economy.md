...
The exact API map and negative mutation classification are recorded in [Phase 002 Pixelmon API evidence](../verification/phase-002/pixelmon-api-2026-09-03.md). The adapter and fixture refusal proof are recorded in [Phase 002 Pixelmon refusal evidence](../verification/phase-002/pixelmon-refusal-2026-09-03.md). The available hybrid bridge stack is classified in the [Phase 002 bridge review](../verification/phase-002/bridge-review-2026-09-03.md). The owner authorized the exact disposable terms before both full launches, as recorded in the [Phase 002 runtime terms authorization](../verification/phase-002/runtime-terms-2026-09-03.md). Full live mutation recovery remains open because the reviewed bridge and direct Pixelmon API do not expose the required durable receipt and idempotent retry contract. No Pixelmon `add` or `take` call is made by the test or production adapter.

The current `2.3.0` artifact reached readiness with the exact Pixelmon profile and with the exact hybrid Vault stack. The [Phase 000 Pixelmon environment verification](../verification/phase-000/p000-task-011-2026-09-04.md) records the live query and typed refusal, and the [Phase 000 hybrid environment verification](../verification/phase-000/p000-task-012-2026-09-04.md) records plugin lifecycle startup and the same refusal through the hybrid stack. These runs used unmodified external jars and a disposable probe outside the FutureShops artifact.
