...
The exact API map and negative mutation classification are recorded in [Phase 002 Pixelmon API evidence](../verification/phase-002/pixelmon-api-2026-09-03.md). The adapter and fixture refusal proof are recorded in [Phase 002 Pixelmon refusal evidence](../verification/phase-002/pixelmon-refusal-2026-09-03.md). Legal terms and full live mutation recovery remain open gates. No Pixelmon `add` or `take` call is made by the test or production adapter.
