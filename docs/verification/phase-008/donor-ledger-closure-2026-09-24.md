...
Focused protocol, admission ordering, client state, codec, session, and ledger tests passed after the phase 008 changes. The full `./gradlew test build` suite passed with 2,024 tests and zero failures or errors. The phase candidate artifact used for the runtime evidence is `build/libs/futureshops-3.0.0-beta.2.jar` with sha256 `998b71ae4abe996dabf748c577ed344132aeb31fb7325ca8061cc8e0335cf2f8`.
