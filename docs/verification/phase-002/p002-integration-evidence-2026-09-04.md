...
| Field | Value |
| --- | --- |
| Source revision | `995b9f386d5a4edbd6db295e06bdee675e205752` |
| FutureShops artifact | `build/libs/futureshops-2.3.0.jar` |
| FutureShops SHA 256 | `a3b3a1bdc1014efcbadf492b20599acb7f7dd35f41b53489de857a104447ac48` |
| FutureShops SHA 512 | `a4b21001342677af52347c96c6dbbbeaf8a2a9c4f313819cbf2e9dbd9e82d8b112cb6a1679831de806e956ecbcdb71796c50d4dc49d353208442fcbcfbec7a0c` |
...
The service loss regression coverage was added after the previous artifact evidence. That earlier exact production artifact was `d7d2e14b192644859a276114508ceb2c5aed8991931aab523b899ffa9d0e4ad3`; its evidence is retained as historical input. The final packaged artifact rerun is recorded below.
...
An earlier packaged artifact from source revision `6bbaf9156bcd8d79bee274717f2ae67d4db6f69e` has SHA 256 `945d175c363ec06f6b0e965161cff081c5deebf1b1ed899e605b48890fc69563` and SHA 512 `0e38cc66eaaf739413f5a8b2f193d97aca40ea4e8c5be18c4f9f29999ccbc6a1a8055045028a796183b623bf6e4d49478134683b23dbe31445e0db96fc02bae2`. The exact Pixelmon `9.4.0` GameTest passed all twenty tests with log SHA 256 `dcc938fbb0cff3cc487f2f573fc6087023c727da511fadc398b98aa675cfcb4c`. A separate restart process passed all twenty tests with log SHA 256 `d78bbea1e02f0ac119adbcfaaa3d3e208d57d2e432650d108c521a37091d869a`. The mixin target applied and both processes exited with code `0`. The final artifact revalidation is recorded below.

The earlier packaged artifact and separately installed proof registrant passed all twenty seven exact NeoForge Vault tests in one packaged runtime. The historical combined route and failure log SHA 256 is `fc96646872f1a0cfcb49af9db3d678a55b1feca5f07ddef6c204eff4fa4947fd`. The proof registrant SHA 256 is `ab578f60f8302f304000ee6d0b401ec36bbb93589357ac6dce3f75cc7539bb30`. It confirms server shop sell, server shop buy, player shop buy, public API withdrawal and deposit, cart buy, pay transfer, physical money refusal, typed service loss, interrupted commits, durable lookup, retry deduplication, late registration, and missing provider refusal with no incomplete custody. The final artifact revalidation is recorded below and in [exact Vault surface GameTest](vault-surface-gametest-2026-09-05.md).

The same earlier packaged artifact also passed the exact Vault failure and recovery matrix in that combined run. All twenty five required tests passed, including typed service loss, each interrupted SQLite boundary, authoritative receipt lookup after a post commit acknowledgement loss, retry deduplication, duplicate and late registration refusal, missing provider resolution, and final balance conservation. See [exact Vault failure and recovery matrix](vault-failure-matrix-2026-09-05.md). The final artifact revalidation is recorded below.

The final packaged artifact revalidation bound the regenerated manifest to source commit `995b9f386d5a4edbd6db295e06bdee675e205752`, SHA 256 `a3b3a1bdc1014efcbadf492b20599acb7f7dd35f41b53489de857a104447ac48`, and SHA 512 `a4b21001342677af52347c96c6dbbbeaf8a2a9c4f313819cbf2e9dbd9e82d8b112cb6a1679831de806e956ecbcdb71796c50d4dc49d353208442fcbcfbec7a0c`. Exact Pixelmon `9.4.0` packaged GameTests passed all twenty tests in two fresh processes with log SHA 256 values `5669b8fb26dbff6562716274dedd7a8bc0136bcf5945e0ba5c819948e86ced8e` and `2241c0a7a416ce68cc6285badcc04544b95ad61b21b769e309cf1b3039bb8f92`. The clean standard server log SHA 256 is `bc03cf906ff40665b1710cc9b878207fa6a8fe5e323633d26f46fc8e2dc94e63`; the incompatible Pixelmon `9.3.1` refusal log SHA 256 is `5e35b3ed8f3e520194bf16e30827501cf323221d39a290024cda7a8a606386a0`; the packaged Vault surface and failure log SHA 256 is `be5ab5a210d8e0d32d026ecec7ff36cd8a6b22a02e772c8e78a38c9cf17a1d19`; and the exact hybrid first and restart log SHA 256 values are `79c383775f83c682c3344ced6e084e15e848d1b0bf00272f6f2b0583f71027ce` and `e8a0b8f0b0e1eaa02ca41af59f9af543ac5fe74a689645c2e2aab0c823f9ee20`. The hybrid restart retained balance `89` and reported `transfer=REPLAYED`. All runtimes were removed after hashing.
...
An earlier production artifact was then exercised in the exact reviewed hybrid stack with the separate proof registrant. The historical first and restart process log SHA 256 values are `da65861f3fe7d3b0fb53cf00bc832884339106cc494b19a67a58398f77f4bca6` and `2e1a5d09df895135d4683e6832fce0e6230feb0734bf3ca00c57c758f7298d86`. Both processes reached `Done` and stopped. The first proof transaction confirmed all provider and coordinator routes. The restart replayed stable requests, reported `transfer=REPLAYED`, and retained balance `89` without a second effect. The final artifact revalidation is recorded below and in [exact hybrid Vault proof](vault-hybrid-proof-2026-09-05.md).

After the fixture added server shop buy and public API route coverage, the current proof registrant was rebuilt with SHA 256 `ab578f60f8302f304000ee6d0b401ec36bbb93589357ac6dce3f75cc7539bb30` and rerun in two fresh exact hybrid processes. The first log SHA 256 is `a01c6428cba7b62e83643058af0a1841acd07014fc4c1691f7133a0f44d96ff4`. The restart log SHA 256 is `71c75f6f5fc5d9390e4f67547c8aa37e69cc38866fa4dcbd6f83a975733ca68c`. Both processes reached `Done`; the restart replayed the stable requests, preserved the resolved claim, and retained balance `89` without a second transfer effect. The disposable runtime was removed after hashing.
