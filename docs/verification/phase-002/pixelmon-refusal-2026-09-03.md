...
The current artifact `945d175c363ec06f6b0e965161cff081c5deebf1b1ed899e605b48890fc69563` was rerun in a fresh copied profile with Pixelmon absent and `provider = "internal"`. It reached `FutureShops common setup complete`, `FutureShops server starting`, and `Done`, then stopped cleanly. The sanitized log is `/tmp/futureshops-current-standard-log.rHnYr9` with SHA 256 `530572c3496d55adc50ff66b539843c3fdc064b8aa1720d493a703b2f6b2d155`. The copied profile verified `eula=true` and was removed after the log was hashed.
...
The current artifact source revision is `eaebabf` on `envy/phase-002-pixelmon-vault`.
