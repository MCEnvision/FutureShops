...
The final review rerun started from a fresh game directory with no `mods` directory. NeoForge discovered the exact DanConomy jar directly from `localRuntime`, applied `DanConomyLedgerDataMixin`, and passed all 32 required GameTests. Its latest log SHA 256 is `95a5c914785c82e30fe15a28d95a11f25186028d8c88b67a1a7863a8dddc70ac`, and its debug log SHA 256 is `1988154319f184fb6540de537bd825ab18562696edca6202f36ccaf5bfac435f`.
...
The packaged `futureshops-2.3.0.jar` built from signed source commit `a98a7dbb8ab478c58f0e09bef6b5d9a2db7d33db` has SHA 256 `eacd0e87addc89ca08161447f1db568526090b4124e2b6ea364fed27623c46db` and SHA 512 `aa7df43efe13dd6790115eb4dbef1b94cbe4355325192c75ab5a74e47bb46103706190f6ff4da1549ff98b06bf60d6abd553f7f2cae2afdaf15d17f906cb3c95`. Archive inspection found the two optional mixin configurations and original FutureShops adapter classes, no nested jar, no external namespace, and no Pixelmon, DanConomy, Vault, or Bukkit artifact bytes.

The exact packaged jar reached `Done` and shut down cleanly under Java 21 in two installed NeoForge server profiles. The DanConomy profile contained only the exact FutureShops jar, DanConomy 1.2.1, and GeckoLib 4.8.4. Its log SHA 256 is `a2c11a2e7a0ad5742632f185d24f9574efefbbfe52491a7f8dae16075ecf6afa`. The standard profile omitted Pixelmon and DanConomy and used the same FutureShops jar. Its log SHA 256 is `fa3b66901fb081163e1c5a794fe84af35746a4890364980d5100b94b2b0ae312`.

A fresh isolated Prism Launcher client profile on the authorized `envision` laptop loaded Minecraft 1.21.1, NeoForge 21.1.248, GeckoLib 4.8.4, and that same FutureShops jar with Pixelmon and DanConomy absent. The owned `Minecraft NeoForge* 1.21.1` window belonged to PID `2146782`, the process was recorded by NVIDIA as a graphics workload on the RTX 5090 laptop GPU, resources reloaded with `mod/futureshops`, and the sound engine reached ready. The isolated profile set and retained `soundCategory_master:0.0` before launch. No PipeWire output stream existed for that exact process at either acceptance check. The client log SHA 256 is `336e95cea53dc1a47e34b412bc1fb7aefdef584cff2699f8bdf85a6b70518fc2`. The exact window and process were closed, the launcher service was stopped, and the isolated profile was removed.
