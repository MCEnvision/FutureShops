...
The exact packaged proof runtime was rerun with the current proof registrant SHA 256 `ab578f60f8302f304000ee6d0b401ec36bbb93589357ac6dce3f75cc7539bb30`. The pure NeoForge packaged surface and failure runtime used the same registrant and pinned SQLite driver, and passed all twenty seven tests with combined log SHA 256 `fc96646872f1a0cfcb49af9db3d678a55b1feca5f07ddef6c204eff4fa4947fd`. Its route assertions include server shop buy and public API withdrawal and deposit in addition to the previously recorded routes.

An earlier artifact process registered `vault`, resolved the provider, completed precheck, withdrawal, lookup, retry, deposit, refund, compensation, custody, claims, and transfer, reached `Done`, and stopped. Its sanitized log SHA 256 is `da65861f3fe7d3b0fb53cf00bc832884339106cc494b19a67a58398f77f4bca6`. The second process reused the same world and provider database. It returned the stable requests as `CONFIRMED`, reported the already resolved claim, reported `transfer=REPLAYED`, retained balance `89`, reached `Done`, and stopped. Its sanitized log SHA 256 is `2e1a5d09df895135d4683e6832fce0e6230feb0734bf3ca00c57c758f7298d86`.
