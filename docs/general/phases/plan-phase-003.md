...
| `DEC-018`, `EXT-008` | Pixelmon class and bytecode inspection, capability, native account, receipt, durable-save, and class-isolation checks; owner-acceptance chronology audit | Exact Pixelmon query, precheck, mixin loading, native mutation, and custom or hybrid refusal integration | Owner-authorized exact disposable Pixelmon runtime | Missing target, missing receipt, failed save, duplicate, missing idempotent retry, ambiguous result, unrecognized account, unscoped call, preacceptance launch refusal | Pixelmon capability and mixin target report, native receipt and save matrix, safe-refusal matrix, environment manifest |
