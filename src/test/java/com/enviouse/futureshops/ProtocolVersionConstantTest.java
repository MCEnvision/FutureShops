...
public class ProtocolVersionConstantTest {
    ...
    @Test
    void protocolVersionIs51() {
        assertEquals("51", ShopPackets.PROTOCOL_VERSION,
                "PROTOCOL_VERSION must be 51 because market capability readiness changed the wire contract");
    }
}
