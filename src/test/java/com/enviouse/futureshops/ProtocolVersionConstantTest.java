...
public class ProtocolVersionConstantTest {
    ...
    @Test
    void protocolVersionIs55() {
        assertEquals("55", ShopPackets.PROTOCOL_VERSION,
                "PROTOCOL_VERSION must be 55 because player shop owner offers changed the wire contract");
    }
}
