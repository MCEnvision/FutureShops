...
public class ProtocolVersionConstantTest {
    ...
    @Test
    void protocolVersionIs52() {
        assertEquals("52", ShopPackets.PROTOCOL_VERSION,
                "PROTOCOL_VERSION must be 52 because ATM recovery synchronization changed the wire contract");
    }
}
