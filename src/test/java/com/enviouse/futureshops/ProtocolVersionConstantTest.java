...
public class ProtocolVersionConstantTest {
    ...
    @Test
    void protocolVersionIs49() {
        assertEquals("49", ShopPackets.PROTOCOL_VERSION,
                "PROTOCOL_VERSION must be 49 because market department counts changed the wire contract");
    }
}
