...
public interface ServerShopBarterItemCustody {
    ...
    static ServerShopBarterItemCustody exact(
        ...
        public Inspection {
            ...
            if (state == State.NONE != receipt.isEmpty()) {
                throw new IllegalArgumentException(
                        "Server shop barter custody inspection is invalid");
            }
        }
    ...
    final class ExactBridge implements ServerShopBarterItemCustody {
