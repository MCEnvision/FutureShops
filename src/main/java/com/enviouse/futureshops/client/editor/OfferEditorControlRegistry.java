...
public final class OfferEditorControlRegistry {
    ...
    private static final Set<String> FIELDS = Set.of(
            "listingId", "displayName", "description", "categoryId",
            "permission", "catalog", "iconItemId", "iconNbt",
            "outputs", "outputs.componentId", "outputs.itemId",
            "outputs.count",
            "outputs.exactNbt", "acquireOptions.optionId",
            "acquireOptions.cost", "acquireOptions.label",
            "acquireOptions.moneyCost",
            "acquireOptions.itemCosts.componentId",
            ...
            "acquireOptions.cooldownSeconds", "sellOptions.optionId",
            "sellOptions.label",
            "sellOptions.moneyPayout", "sellOptions.capacity",
            "sellOptions.itemInputs", "sellOptions.itemInputs.componentId",
