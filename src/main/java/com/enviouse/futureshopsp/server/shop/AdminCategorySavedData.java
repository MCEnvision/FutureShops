...
public class AdminCategorySavedData extends SavedData {
     ...
     * normalized id used by {@link com.enviouse.futureshopsp.catalog.ShopCatalog#buildCategories}.
     */
    ...
    public static AdminCategorySavedData get(MinecraftServer server) {
        return server.overworld().getDataStorage()
                .computeIfAbsent(new SavedData.Factory<>(AdminCategorySavedData::new, AdminCategorySavedData::load, null), DATA_NAME);
    }
    ...
    private static AdminCategorySavedData load(CompoundTag tag, HolderLookup.Provider provider) {
