...
public class DepartmentSavedData extends SavedData {
    ...
    public static DepartmentSavedData get(MinecraftServer server) {
        return server.overworld().getDataStorage()
                .computeIfAbsent(new SavedData.Factory<>(DepartmentSavedData::new, DepartmentSavedData::load, null), DATA_NAME);
    }
    ...
    private static DepartmentSavedData load(CompoundTag tag, HolderLookup.Provider provider) {
