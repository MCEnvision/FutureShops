...
public class ShopBlockGeoRenderer implements BlockEntityRenderer<ShopBlockEntity> {
    ...
    private static void startSkinFetch(UUID uuid, String name) {
        try {
            // Owner-head live skin fetch deferred to the client-skin cluster: 1.21.1 changed the
            // SkinManager/SkullBlockEntity profile pipeline (PlayerSkin/ResolvableProfile).
            // Default skin is used until that is ported.
        } catch (Throwable t) {
