...
public class DepartmentPickerScreen extends AbstractShopScreen implements ShopScreenMarker {
    ...
    protected void init() {
        ...
        ShopPackets.sendToServer(new C2SFetchDepartmentsPacket(""));
    }
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (lastSearchMs > 0 && System.currentTimeMillis() - lastSearchMs >= 300) {
            lastSearchMs = 0;
            ShopPackets.sendToServer(new C2SFetchDepartmentsPacket(lastQuery));
        }
    ...
    private void applyDepartment() {
        ...
        ShopPackets.sendToServer(new C2SSetDepartmentPacket(
