...
The 3.0 implementation is in beta pending owner approval. `FutureShops3-0Plan.MD` remains the source of truth for unfinished requirements. Current code and tests establish implemented behavior. Focused operator documentation is available in:
